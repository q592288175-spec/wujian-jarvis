...
export const sessionParameters=()=>({asr:{extra:{end_smooth_window_ms:700}},tts:{speaker:'zh_female_xiaohe_jupiter_bigtts'},dialog:{bot_name:'小木',system_role:'你是小木的语音通道。不要提供金融分析，实际研究由外部工具处理。',speaking_style:'简短自然的普通话',extra:{input_mod:'audio',model:'O',recv_timeout:60}}});
