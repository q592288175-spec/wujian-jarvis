...
export function bindingSummary(){return {bound:!!(saved?.appId&&!saved.disabled),disabled:saved?.disabled===true,boundAt:saved?.boundAt||null,channel:'feishu',agent:'小木 国内期货研究 Agent'};}
