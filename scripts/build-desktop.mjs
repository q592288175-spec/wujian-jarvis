...
const output=await packager({dir:stage,...(existsSync(zip)?{electronZipDir:zipDir}:{}),name:'五简 JARVIS',platform:'darwin',arch:'arm64',electronVersion:'44.4.3',out:resolve('.runtime/desktop-build'),overwrite:true,asar:true,appBundleId:'com.wujian.jarvis',appVersion:'0.3.0',extendInfo:{NSMicrophoneUsageDescription:'用于你主动发起的 JARVIS 语音通话。'}});
